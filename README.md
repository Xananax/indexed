...
Documentation will come later, in the meantime, have a look at the tests, all 151 of them, which is not enough, but a good start. There's a generated [`spec.md`](./spec.md).
